 ...
 */
class QAComment extends ActiveRecord implements ContentTitlePreview
{
	...
	{
		$activity = new \humhub\modules\questionanswer\activities\QAComment();
	...
	{
		return Yii::t('CommentModule.models_comment', 'QAComment');
	}
