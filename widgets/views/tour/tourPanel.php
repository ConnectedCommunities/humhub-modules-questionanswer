<div class="panel panel-default panel-tour" id="getting-started-panel">
    ...
    <div class="panel-body">
        ...
        $chat = Yii::app()->user->getModel()->getSetting("chat", "tour");
        ...
        <ul class="tour-list">
            ...
            <li class="<?php if ($spaces == 1) : ?>completed<?php endif; ?>"><a id="interface-tour-link" href="<?php echo Yii::app()->createUrl('//tour/tour/startSpaceTour'); ?>"><i class="fa fa-play-circle-o"></i><?php echo Yii::t('TourModule.widgets_views_tourPanel', '<strong>Guide:</strong> Mentorship Circle'); ?></a></li>
            <li class="<?php if ($chat == 1) : ?>completed<?php endif; ?>"><a href="<?php echo Yii::app()->createUrl('//chat/chat/index', array('uguid' => Yii::app()->user->guid, 'tour' => 'true')); ?>"><i class="fa fa-play-circle-o"></i><?php echo Yii::t('TourModule.widgets_views_tourPanel', '<strong>Guide:</strong> Chat'); ?></a></li>
